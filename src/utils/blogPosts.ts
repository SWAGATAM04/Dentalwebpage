...
export const blogPosts: BlogPost[] = [
  {
    ...
    seoTitle: 'Dental Hygiene Tips: 5 Essential Practices for a Healthy Smile | Revital Dental Austin',
  ...
  },
  {
    ...
    seoTitle: 'How to Choose the Best Toothbrush: Expert Guide | Revital Dental Austin',
